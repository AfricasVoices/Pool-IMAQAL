...
PIPELINE_CONFIGURATION = PipelineConfiguration(
    pipeline_name="SDC S03 CHASP Rapid Survey Pipeline",
    description="SDC Somalia CHASP S03 Rapid Survey data pipeline",
    ...
    kobotoolbox_sources=[
        KoboToolBoxSource(
            ...
            sync_config=KoboToolBoxToEngagementDBConfiguration(
                asset_uid="aZAq9rbp6Kjc2zaEBCgG7r",
                ignore_invalid_mobile_numbers=True,
                question_configurations=[
                    KoboToolBoxQuestionConfiguration(data_column_name="group_up01j36/Support_level", engagement_db_dataset="sdc_chasp_s03_support_level"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_up01j36/Support_improvements", engagement_db_dataset="sdc_chasp_s03_support_improvements"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_up01j36/Feedback_level", engagement_db_dataset="sdc_chasp_s03_feedback_level"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_up01j36/Feedback_Improvements", engagement_db_dataset="sdc_chasp_s03_feedback_improvements"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_up01j36/Inclusion_level", engagement_db_dataset="sdc_chasp_s03_inclusion_level"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_up01j36/Inclusion_Improvements", engagement_db_dataset="sdc_chasp_s03_inclusion_improvements"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_up01j36/Government_level", engagement_db_dataset="sdc_chasp_s03_government_level"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_up01j36/Government_Improvements", engagement_db_dataset="sdc_chasp_s03_government_improvements"),

                    KoboToolBoxQuestionConfiguration(data_column_name="group_uo69k22/Location", engagement_db_dataset="location"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_uo69k22/Household_Languages", engagement_db_dataset="household_language"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_uo69k22/Gender", engagement_db_dataset="gender"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_uo69k22/Age", engagement_db_dataset="age"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_uo69k22/Disability", engagement_db_dataset="disability"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_uo69k22/Displacement", engagement_db_dataset="recently_displaced"),
                ]
            )
        ),    
    ],
    coda_sync=CodaConfiguration(
        ...
        sync_config=CodaSyncConfiguration(
            dataset_configurations=[
                ...
                # RQA datasets
                make_rqa_coda_dataset_config("sdc_chasp_s03_support_level"),
                make_rqa_coda_dataset_config("sdc_chasp_s03_support_improvements"),
                make_rqa_coda_dataset_config("sdc_chasp_s03_feedback_level"),
                make_rqa_coda_dataset_config("sdc_chasp_s03_feedback_improvements"),
                make_rqa_coda_dataset_config("sdc_chasp_s03_inclusion_level"),
                make_rqa_coda_dataset_config("sdc_chasp_s03_inclusion_improvements"),
                make_rqa_coda_dataset_config("sdc_chasp_s03_government_level"),
                make_rqa_coda_dataset_config("sdc_chasp_s03_government_improvements"),
            ],
    ...
    analysis=AnalysisConfiguration(
        google_drive_upload=GoogleDriveUploadConfiguration(
            ...
            drive_dir="sdc_chasp_s03_analysis_outputs"
        ),
        dataset_configurations=[
            ...
            make_analysis_dataset_config("sdc_chasp_s03_support_level"),
            make_analysis_dataset_config("sdc_chasp_s03_support_improvements"),
            make_analysis_dataset_config("sdc_chasp_s03_feedback_level"),
            make_analysis_dataset_config("sdc_chasp_s03_feedback_improvements"),
            make_analysis_dataset_config("sdc_chasp_s03_inclusion_level"),
            make_analysis_dataset_config("sdc_chasp_s03_inclusion_improvements"),
            make_analysis_dataset_config("sdc_chasp_s03_government_level"),
            make_analysis_dataset_config("sdc_chasp_s03_government_improvements"),
        ],
        ws_correct_dataset_code_scheme=load_code_scheme("ws_correct_dataset"),
        traffic_labels=[]
    )
