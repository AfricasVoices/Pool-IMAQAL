...
PIPELINE_CONFIGURATION = PipelineConfiguration(
    ...
    coda_sync=CodaConfiguration(
        ...
        sync_config=CodaSyncConfiguration(
            dataset_configurations=[
                ...
                CodaDatasetConfiguration(
                    coda_dataset_id="SDC_Somalia_PDRC_s01e04",
                    engagement_db_dataset="sdc_somalia_pdrc_s01e04",
                    code_scheme_configurations=[
                        CodeSchemeConfiguration(code_scheme=load_code_scheme("rqas/sdc_somalia/pdrc_s01e04"),
                                                coda_code_schemes_count=3),
                    ],
                    ws_code_match_value="sdc_somalia_pdrc_s01e04"
                ),
                CodaDatasetConfiguration(
                    coda_dataset_id="SDC_Somalia_PDRC_s01e05",
                    engagement_db_dataset="sdc_somalia_pdrc_s01e05",
                    code_scheme_configurations=[
                        CodeSchemeConfiguration(code_scheme=load_code_scheme("rqas/sdc_somalia/pdrc_s01e05"),
                                                coda_code_schemes_count=3),
                    ],
                    ws_code_match_value="sdc_somalia_pdrc_s01e05"
                ),
                CodaDatasetConfiguration(
                    coda_dataset_id="SDC_Somalia_PDRC_s01_have_voice",
                    engagement_db_dataset="sdc_somalia_pdrc_s01_have_voice",
                    code_scheme_configurations=[
                        CodeSchemeConfiguration(code_scheme=load_code_scheme("rqas/sdc_somalia/pdrc_s01_have_voice"),
                                                coda_code_schemes_count=3),
                    ],
    ...
    analysis=AnalysisConfiguration(
        ...
        dataset_configurations=[
            ...
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_somalia_pdrc_s01e04"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="pdrc_s01e04_raw",
                coding_configs=[
                    CodingConfiguration(
                        code_scheme=load_code_scheme("rqas/sdc_somalia/pdrc_s01e04"),
                        analysis_dataset="pdrc_s01e04"
                    )
                ]
            ),
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_somalia_pdrc_s01e05"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="pdrc_s01e05_raw",
                coding_configs=[
                    CodingConfiguration(
                        code_scheme=load_code_scheme("rqas/sdc_somalia/pdrc_s01e05"),
                        analysis_dataset="pdrc_s01e05"
                    )
                ]
            ),
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_somalia_pdrc_s01_have_voice"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="pdrc_s01_have_voice_raw",
                coding_configs=[
                    CodingConfiguration(
