...
PIPELINE_CONFIGURATION = PipelineConfiguration(
    pipeline_name="SDC-Somalia-PDRC",
    description="Runs the SDC-Somalia programme's PDRC project pipeline. This project takes place in Puntland only.",
        ...
        RapidProSource(
            ...
            sync_config=RapidProToEngagementDBConfiguration(
                flow_result_configurations=[
                    FlowResultConfiguration("sdc_somalia_demog", "imaqal_pool_district", "location"),
        ...
        sync_config=CodaSyncConfiguration(
            dataset_configurations=[
                CodaDatasetConfiguration(
                    coda_dataset_id="SDC_Somalia_PDRC_s01e01",
                    engagement_db_dataset="sdc_somalia_pdrc_s01e01",
                    code_scheme_configurations=[
                        CodeSchemeConfiguration(code_scheme=load_code_scheme("rqas/sdc_somalia/pdrc_s01e01"),
                                                coda_code_schemes_count=3),
                    ],
                    ws_code_match_value="sdc_somalia_pdrc_s01e01"
                ),
                CodaDatasetConfiguration(
                    coda_dataset_id="SDC_Somalia_PDRC_s01e02",
                    engagement_db_dataset="sdc_somalia_pdrc_s01e02",
                    code_scheme_configurations=[
                        CodeSchemeConfiguration(code_scheme=load_code_scheme("rqas/sdc_somalia/pdrc_s01e02"),
                                                coda_code_schemes_count=3),
                    ],
    ...
    archive_configuration=ArchiveConfiguration(
        ...
        bucket_dir_path="2022/SDC-Somalia-PDRC"
    ),
    analysis=AnalysisConfiguration(
        google_drive_upload=GoogleDriveUploadConfiguration(
            credentials_file_url="gs://avf-credentials/pipeline-runner-service-acct-avf-data-core-64cc71459fe7.json",
            drive_dir="sdc_somalia_analysis_outputs/pdrc"
        ),
        dataset_configurations=[
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_somalia_pdrc_s01e01"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="pdrc_s01e01_raw",
                coding_configs=[
                    CodingConfiguration(
                        code_scheme=load_code_scheme("rqas/sdc_somalia/pdrc_s01e01"),
                        analysis_dataset="pdrc_s01e01"
                    )
                ]
            ),
            AnalysisDatasetConfiguration(
