...
PIPELINE_CONFIGURATION = PipelineConfiguration(
    ...
    analysis=AnalysisConfiguration(
        ...
        traffic_labels=[
            ...
            TrafficLabel(isoparse("2022-03-21T00:00+03:00"), isoparse("2022-03-21T17:30+03:00"), "E02 None (Post Promo)"),
            ...
            TrafficLabel(isoparse("2022-03-23T00:00+03:00"), isoparse("2022-03-25T24:00+03:00"), "E02 None (Post Radio)"),

            TrafficLabel(isoparse("2022-03-26T00:00+03:00"), isoparse("2022-03-27T24:00+03:00"), "E03 Promo"),
            TrafficLabel(isoparse("2022-03-28T00:00+03:00"), isoparse("2022-03-28T17:30+03:00"), "E03 None (Post Promo)"),
            ...
            TrafficLabel(isoparse("2022-03-30T00:00+03:00"), isoparse("2022-04-01T24:00+03:00"), "E03 None (Post Radio)"),

            TrafficLabel(isoparse("2022-04-02T00:00+03:00"), isoparse("2022-04-03T24:00+03:00"), "E04 Promo"),
            TrafficLabel(isoparse("2022-04-04T00:00+03:00"), isoparse("2022-04-04T17:30+03:00"), "E04 None (Post Promo)"),
            ...
            TrafficLabel(isoparse("2022-04-06T00:00+03:00"), isoparse("2022-04-08T24:00+03:00"), "E04 None (Post Radio)"),

            TrafficLabel(isoparse("2022-04-09T00:00+03:00"), isoparse("2022-04-10T24:00+03:00"), "E05 Promo"),
            TrafficLabel(isoparse("2022-04-11T00:00+03:00"), isoparse("2022-04-11T17:30+03:00"), "E05 None (Post Promo)"),
            ...
            TrafficLabel(isoparse("2022-04-13T00:00+03:00"), isoparse("2022-04-15T24:00+03:00"), "E05 None (Post Radio)"),

            TrafficLabel(isoparse("2022-04-16T00:00+03:00"), isoparse("2022-04-17T24:00+03:00"), "E06 Promo"),
            TrafficLabel(isoparse("2022-04-18T00:00+03:00"), isoparse("2022-04-18T17:30+03:00"), "E06 None (Post Promo)"),
            ...
            TrafficLabel(isoparse("2022-04-20T00:00+03:00"), isoparse("2022-04-22T24:00+03:00"), "E06 None (Post Radio)"),
        ]
    ),
