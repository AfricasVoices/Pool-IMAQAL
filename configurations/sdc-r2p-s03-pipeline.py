...
PIPELINE_CONFIGURATION = PipelineConfiguration(
    pipeline_name="SDC R2P S03 Rapid Survey Pipeline",
    description="SDC Somalia R2P S03 Rapid Survey data pipeline",
    ...
    kobotoolbox_sources=[
        KoboToolBoxSource(
            ...
            sync_config=KoboToolBoxToEngagementDBConfiguration(
                asset_uid="aBPExGv7DSxKptTAdwWgtT",
                ignore_invalid_mobile_numbers=True,
                question_configurations=[
                    KoboToolBoxQuestionConfiguration(data_column_name="group_sv9kz26/Empowerment_level", engagement_db_dataset="sdc_r2p_s03_empowerment_level"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_sv9kz26/Empowerment_improvements", engagement_db_dataset="sdc_r2p_s03_empowerment_improvements"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_sv9kz26/Impact_level", engagement_db_dataset="sdc_r2p_s03_impact_level"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_sv9kz26/Impact_Improvements", engagement_db_dataset="sdc_r2p_s03_impact_improvements"),

                    KoboToolBoxQuestionConfiguration(data_column_name="group_ma0ko76/Location", engagement_db_dataset="location"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_ma0ko76/Household_Languages", engagement_db_dataset="household_language"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_ma0ko76/Gender", engagement_db_dataset="gender"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_ma0ko76/Age", engagement_db_dataset="age"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_ma0ko76/Disability", engagement_db_dataset="disability"),
                    KoboToolBoxQuestionConfiguration(data_column_name="group_ma0ko76/Displacement", engagement_db_dataset="recently_displaced"),
                ]
            )
        ),    
    ],
    coda_sync=CodaConfiguration(
        ...
        sync_config=CodaSyncConfiguration(
            dataset_configurations=[
                ...
                # RQA datasets
                make_rqa_coda_dataset_config("sdc_r2p_s03_empowerment_level"),
                make_rqa_coda_dataset_config("sdc_r2p_s03_empowerment_improvements"),
                make_rqa_coda_dataset_config("sdc_r2p_s03_impact_level"),
                make_rqa_coda_dataset_config("sdc_r2p_s03_impact_improvements")
            ],
    ...
    analysis=AnalysisConfiguration(
        google_drive_upload=GoogleDriveUploadConfiguration(
            ...
            drive_dir="sdc_r2p_s03_analysis_outputs"
        ),
        dataset_configurations=[
            ...
            make_analysis_dataset_config("sdc_r2p_s03_empowerment_level"),
            make_analysis_dataset_config("sdc_r2p_s03_empowerment_improvements"),
            make_analysis_dataset_config("sdc_r2p_s03_impact_level"),
            make_analysis_dataset_config("sdc_r2p_s03_impact_improvements")
        ],
        ws_correct_dataset_code_scheme=load_code_scheme("ws_correct_dataset"),
        traffic_labels=[]
    )
