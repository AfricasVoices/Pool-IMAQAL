...
PIPELINE_CONFIGURATION = PipelineConfiguration(
    pipeline_name="SDC S03 Rapid Survey",
    description="SDC Somalia S03 Rapid Survey",
        ...
        RapidProSource(
            ...
            sync_config=RapidProToEngagementDBConfiguration(
                flow_result_configurations=[
                    FlowResultConfiguration("sdc_survey_s03_demog", "imaqal_pool_district", "location"),
                    FlowResultConfiguration("sdc_survey_s03_demog", "imaqal_pool_gender", "gender"),
                    FlowResultConfiguration("sdc_survey_s03_demog", "imaqal_pool_age", "age"),
                    FlowResultConfiguration("sdc_survey_s03_demog", "imaqal_pool_recently_displaced", "recently_displaced"),
                    FlowResultConfiguration("sdc_survey_s03_demog", "imaqal_pool_disability", "disability"),
                    FlowResultConfiguration("sdc_survey_s03_demog", "imaqal_pool_household_language", "household_language"),

                    FlowResultConfiguration("sdc_survey_s03e01_activation", "rqa_s03e01", "sdc_survey_s03e01"),
                    FlowResultConfiguration("sdc_survey_s03e01_follow_up_activation", "rqa_s03e01_follow_up", "sdc_survey_s03e01_follow_up"),

                    FlowResultConfiguration("sdc_survey_s03e02_activation", "rqa_s03e02", "sdc_survey_s03e02"),
                    FlowResultConfiguration("sdc_survey_s03e02_follow_up_activation", "rqa_s03e02_follow_up", "sdc_survey_s03e02_follow_up"),

                    FlowResultConfiguration("sdc_survey_s03e03_activation", "rqa_s03e03", "sdc_survey_s03e03"),
                    FlowResultConfiguration("sdc_survey_s03e03_follow_up_activation", "rqa_s03e03_follow_up", "sdc_survey_s03e03_follow_up"),
                ]
            )
        )
    ],
    coda_sync=CodaConfiguration(
        ...
        sync_config=CodaSyncConfiguration(
            dataset_configurations=[
                ...
                CodaDatasetConfiguration(
                    coda_dataset_id="SDC_Survey_s03e03_follow_up",
                    engagement_db_dataset="sdc_survey_s03e03_follow_up",
                    code_scheme_configurations=[
                        CodeSchemeConfiguration(code_scheme=load_code_scheme("rqas/sdc_survey_s03e03_follow_up"),
                                                coda_code_schemes_count=3),
                    ],
                    ws_code_match_value="sdc_survey_s03e03_follow_up"
                ),
                CodaDatasetConfiguration(
                ...
                CodaDatasetConfiguration(
                    coda_dataset_id="SDC_Survey_s03e02_follow_up",
                    engagement_db_dataset="sdc_survey_s03e02_follow_up",
                    code_scheme_configurations=[
                        CodeSchemeConfiguration(code_scheme=load_code_scheme("rqas/sdc_survey_s03e02_follow_up"),
                                                coda_code_schemes_count=3),
                    ],
                    ws_code_match_value="sdc_survey_s03e02_follow_up"
                ),
                CodaDatasetConfiguration(
                ...
                CodaDatasetConfiguration(
                    coda_dataset_id="SDC_Survey_s03e01_follow_up",
                    engagement_db_dataset="sdc_survey_s03e01_follow_up",
                    code_scheme_configurations=[
                        CodeSchemeConfiguration(code_scheme=load_code_scheme("rqas/sdc_survey_s03e01_follow_up"),
                                                coda_code_schemes_count=3),
                    ],
                    ws_code_match_value="sdc_survey_s03e01_follow_up"
                ),
                CodaDatasetConfiguration(
    ...
    analysis=AnalysisConfiguration(
        google_drive_upload=GoogleDriveUploadConfiguration(
            ...
            drive_dir="sdc_s03_rapid_survey_analysis_outputs"
        ),
        dataset_configurations=[
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_survey_s03e03"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="sdc_survey_s03e03_raw",
                coding_configs=[
                    CodingConfiguration(
                        code_scheme=load_code_scheme("rqas/sdc_survey_s03e03"),
                        analysis_dataset="sdc_survey_s03e03"
                    )
                ]
            ),
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_survey_s03e03_follow_up"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="sdc_survey_s03e03_follow_up_raw",
                coding_configs=[
                    CodingConfiguration(
                        code_scheme=load_code_scheme("rqas/sdc_survey_s03e03_follow_up"),
                        analysis_dataset="sdc_survey_s03e03_follow_up"
                    )
                ]
            ),
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_survey_s03e02"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="sdc_survey_s03e02_raw",
                coding_configs=[
                    CodingConfiguration(
                        code_scheme=load_code_scheme("rqas/sdc_survey_s03e02"),
                        analysis_dataset="sdc_survey_s03e02"
                    )
                ]
            ),
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_survey_s03e02_follow_up"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="sdc_survey_s03e02_follow_up_raw",
                coding_configs=[
                    CodingConfiguration(
                        code_scheme=load_code_scheme("rqas/sdc_survey_s03e02_follow_up"),
                        analysis_dataset="sdc_survey_s03e02_follow_up"
                    )
                ]
            ),
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_survey_s03e01"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="sdc_survey_s03e01_raw",
                coding_configs=[
                    CodingConfiguration(
                        code_scheme=load_code_scheme("rqas/sdc_survey_s03e01"),
                        analysis_dataset="sdc_survey_s03e01"
                    )
                ]
            ),
            AnalysisDatasetConfiguration(
                engagement_db_datasets=["sdc_survey_s03e01_follow_up"],
                dataset_type=DatasetTypes.RESEARCH_QUESTION_ANSWER,
                raw_dataset="sdc_survey_s03e01_follow_up_raw",
                coding_configs=[
                    CodingConfiguration(
                        code_scheme=load_code_scheme("rqas/sdc_survey_s03e01_follow_up"),
                        analysis_dataset="sdc_survey_s03e01_follow_up"
                    )
                ]
            ),
